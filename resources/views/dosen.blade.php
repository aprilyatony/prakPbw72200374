                ...
                <div class="col-lg-10 col-md-9 col-sm-8 col-12 vh-100 mt-2">
                    <div class="card">
                        <div class="card-header">
                            <a name="" class="btn btn-primary" href="/dosen/formDosen" role="button"><i class="bi bi-file-earmark-plus"></i>Add Dosen</a>
                    ...
                    <th scope="row">{{ $dosen->firstItem() + $no }}</th>
                            ...
                            <td>{{$ds->pakar}}</td>
                        <td>
                            <a href="/dosen/editdosen/{{ $ds->id }}" class="btn btn-outline-primary"><i class="bi bi-pencil-square"></i></a>
                            <a href="/dosen/deletedosen/{{ $ds->id }}" class="btn btn-outline-primary"
