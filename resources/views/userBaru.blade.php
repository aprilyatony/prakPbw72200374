    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                ...
                <a class="dropdown-item" href="/usser">Data Pengguna</a>
                ...
                <div class="col-lg-10 col-md-9 col-sm-8 col-12 vh-100 mt-2">
                    <div class="card">
                        <div class="card-header">
                            <a name="" class="btn btn-primary" href="/usser/formuliruser2" role="button"><i class="bi bi-file-earmark-plus"></i>Add Pengguna</a>
                    ...
                    <tbody>
                    @foreach ($userBaru as $no => $us)
                    <tr>
                        <th scope="row">{{ $userBaru->firstItem() + $no }}</th>
                        <td>{{$us->nik_user}}</td>
                        <td>{{$us->nama_user}}</td>
                        <td>{{$us->no_hp}}</td>
                        <td>{{$us->password}}</td>
                        <td>
                            <a href="/usser/edituser2/{{ $us->id }}" class="btn btn-outline-primary"><i class="bi bi-pencil-square"></i></a>
                            <a href="/usser/deleteuser2/{{ $us->id }}" class="btn btn-outline-primary"
                    ...
                    <span class="float-right">{{ $userBaru->links() }}</span>
                </div> 
                </div>
            </div>
</div>
